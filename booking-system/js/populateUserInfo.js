...
function populateBookings() {
    ...
    bookingRequest.open("GET", "booking-system/php/get_user_bookings.php", true);
    bookingRequest.onload = function () {
        if (bookingRequest.readyState == 4 && bookingRequest.status == 200) {
            ...
            for (i = 0; i < arrayBookings.length; i++) {
...
function populateTimeAllocations() {
    ...
    accountRequest.open("GET", "booking-system/php/get_user_account.php", true);
    accountRequest.send();
