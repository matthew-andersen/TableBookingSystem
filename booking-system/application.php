    ...
    <svg height="698pt" preserveaspectratio="xMidYMid meet" version="1.0" viewbox="0 0 971 698"
        ...
        <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)"
           fill="#000000" stroke="none">
            <path d="M4850 4910 l0 -1690 660 0 660 0 0 30 0 30 -630 0 -630 0 0 575 0
575 780 0 780 0 0 -575 0 -575 30 0 30 0 0 575 0 575 440 0 440 0 0 -365 0
-364 -206 -211 -207 -210 -83 0 -84 0 0 -30 0 -30 93 0 92 0 228 228 227 227
0 1118 0 1117 565 0 565 0 0 30 0 30 -950 0 -950 0 0 65 0 65 -30 0 -30 0 0
-805 0 -805 -380 0 -380 0 0 1025 0 1025 380 0 380 0 0 -40 c0 -38 2 -40 30
-40 l30 0 0 70 0 70 -485 0 -485 0 0 -30 c0 -29 2 -30 45 -30 l45 0 0 -1025 0
-1025 -455 0 -455 0 0 1025 0 1025 225 0 225 0 0 30 0 30 -255 0 -255 0 0
-1690z m2560 290 l0 -710 -355 0 -355 0 0 710 0 710 355 0 355 0 0 -710z"/>
...
0 160 100 0 100 0 0 -160z"/>
            <path d="M7550 1865 l0 -375 30 0 30 0 0 375 0 375 -30 0 -30 0 0 -375z"/>
        </g>
        ...
        <a fill="white" href="#" id="room_4" onclick="handlePopup('room_4', 'Room 4')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)" stroke="none">
                <path
                    d="M6530 3855 l0 -575 234 0 233 0 207 210 206 211 0 364 0 365 -440 0 -440 0 0 -575z">
                </path>
            </g>
        </a>

        <a fill="white" href="#" id="room_5" onclick="handlePopup('room_5', 'Room 5')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)" stroke="none">
                <path
                    d="M8420 4832 c-102 -179 -154 -283 -212 -427 l-77 -190 -1 -282 0 -283 545 0 545 0 0 710 0 710 -332 0 -333 -1 -135 -237z"></path>
            </g>
        </a>

        <a fill="white" href="#" id="room_6" onclick="handlePopup('room_6', 'Room 6')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)" stroke="none">
                <path d="M8130 3100 l0 -490 545 0 545 0 0 490 0 490 -545 0 -545 0 0 -490z"></path>
            </g>
        </a>


        <a fill="white" href="#" id="room_7" onclick="handlePopup('room_7', 'Room 7')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path
        ...
        <a fill="white" href="#" id="desk_9" onclick="handlePopup('desk_9', 'Desk 9')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path d="M3480 3595 l0 -155 100 0 100 0 0 155 0 155 -100 0 -100 0 0 -155z"></path>
            </g>
        </a>

        <a fill="white" href="#" id="desk_10" onclick="handlePopup('desk_10', 'Desk 10')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path d="M3710 3595 l0 -155 100 0 100 0 0 155 0 155 -100 0 -100 0 0 -155z"></path>
            </g>
        </a>

        <a fill="white" href="#" id="desk_11" onclick="handlePopup('desk_11', 'Desk 11')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path d="M3480 3250 l0 -160 100 0 100 0 0 160 0 160 -100 0 -100 0 0 -160z"></path>
            </g>
        </a>

        <a fill="white" href="#" id="desk_12" onclick="handlePopup('desk_12', 'Desk 12')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path d="M3710 3250 l0 -160 100 0 100 0 0 160 0 160 -100 0 -100 0 0 -160z"></path>
            </g>
        </a>

        <a fill="white" href="#" id="desk_13" onclick="handlePopup('desk_13', 'Desk 13')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path d="M3480 2900 l0 -160 100 0 100 0 0 160 0 160 -100 0 -100 0 0 -160z"></path>
            </g>
        </a>

        <a fill="white" href="#" id="desk_14" onclick="handlePopup('desk_14', 'Desk 14')">
            <g transform="translate(0.000000,698.000000) scale(0.100000,-0.100000)">
                <path d="M3710 2900 l0 -160 100 0 100 0 0 160 0 160 -100 0 -100 0 0 -160z"></path>
            </g>
        </a>
